...
public class CompatibilityActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        OneClickStats.sendEvent(this,
                OneClickStats.Categories.PAGE_SHOWN, OneClickStats.Actions.PAGE_COMPAT_CHECK);
        ...
        findViewById(R.id.continue_anyway).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                OneClickStats.sendEvent(view.getContext(),
                        OneClickStats.Categories.BUTTON_CLICK, OneClickStats.Actions.BTN_UNSUPP_CONT);
                startMainActivity();
            }
        });
    }
